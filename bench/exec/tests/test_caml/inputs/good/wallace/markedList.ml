(* $Header: /home/pauillac/formel1/fpottier/cvs/wallace/markedList.ml,v 1.3 2001/03/19 18:25:24 fpottier Exp $ *)
...
module Make (X : sig
  ...
  (* [mark_and_sweep root list1] walks [list1], marking elements as it goes. Then, it computes [root()], which must
     yield a list of unmarked elements. (That is, any elements which happen to be marked, possibly because they
