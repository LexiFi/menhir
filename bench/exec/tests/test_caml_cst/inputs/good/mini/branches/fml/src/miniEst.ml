...
and expression =
  ...
  | EAppAnnoted of position * expression * expression * annotation_option
  ...
  | EImpredicativity of position * expression * variable list * crterm option * crterm option
  
  (** Algebraic datatypes. *) 
  | EDCon of position * dname
  | EMatchAnnoted of position * expression * annotation_option * (clause list) 
...
and annotation_option = existential_crterm option
...
and value_definition =
    position * variable list * pattern * expression * annotation_option
