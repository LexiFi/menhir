...
Pottier~\citeyear{pottier-reachability}, consists in selecting a diagnostic
...
As an example, here is a valid entry, taken from \menhir's own \messages file:
\begin{verbatim}
    grammar: TYPE UID 
...
this state, in the same format as in an \automaton file. Then, it shows what
...
In a noncanonical automaton, which is by default what \menhir produces, the
...
Pottier's paper~\citeyear{pottier-reachability} for details.
