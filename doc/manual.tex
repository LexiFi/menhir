...
to be written to the file \nt{basename}\automaton. This description
is written \emph{before} conflicts have been resolved (\sref{sec:conflicts})
and extra reductions have been introduced (\sref{sec:onerrorreduce}).
...
description is written \emph{after} conflicts have been resolved
(\sref{sec:conflicts}) and extra reductions have been introduced
