...
let test program nt sentence =
  ...
  then
    eprintf
      "StackLangTester: About to test this sentence:\n  %s%!"
  ...
  then begin
    eprintf
      "StackLangTester: Error: reference and candidate disagree.\n%s"
      (Interpret.print_sentence (Some nt, sentence));
...
let test program nt =
  ...
  let sentences = SentenceEnumerator.sentences nt in
