...
module Analysis : sig
  ...
  (**[maximal nt] is the maximal size of a sentence generated by the
     nonterminal symbol [nt]. An unbounded maximal size is represented
     by the special value [max_int]. This analysis is carried out under
     the assumption that every symbol generates a nonempty language. *)
  val maximal: Nonterminal.t -> int

  (**[maximal_prod prod i] is the maximal size of a sentence generated
     by the suffix of the production [prod] defined by the offset [i]. *)
