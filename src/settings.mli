...
(** The undocumented flag [--example-size size] sets the maximal size of the
   example to [size]. That maximum is not reached most of the time. *)
val example_size: int

(** The undocumented flag [--provide-example-seed] logs information about example
   generation. *)
val example_log: bool

(** The undocumented flag [--old-code-backend] makes menhir use the magic code
